...
export const metadata: Metadata = {
  ...
  description: 'Mine a Planet Wiki privacy policy.',
}
    ...
    <main className="min-h-screen px-4 pt-28 pb-16">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-5 text-muted-foreground leading-7">
          <p>This privacy policy explains how Mine a Planet Wiki handles basic site usage data.</p>
          ...
          <p>For privacy questions, contact contact@mineaplanet.online.</p>
        </div>
      </div>
    </main>
  )

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://www.mineaplanet.online";
      ...
      images: [
        {
          ...
          width: 1920,
          height: 1080,
          alt: "Mine a Planet - Roblox Planet Mining Tycoon Guide",
        },
      ],
    },
    twitter: {
